...
public class HotelListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        hotellist.setLayoutManager(new LinearLayoutManager(getContext(),RecyclerView.VERTICAL,false));
        hotellist.addItemDecoration(new DividerItemDecoration(getContext(),1));
        hotels = new ArrayList<>();
        loadHotels();
        adapter = new AdapterHome(this,hotels);
